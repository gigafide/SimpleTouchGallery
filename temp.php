<?php
	...
	$xml = simplexml_load_file("http://localhost/temp/config.xml");
	...
	if($_FILES['bg_upload']['name']){
		...
		move_uploaded_file($_FILES['bg_upload']['tmp_name'], 'temp/bg_img.' . $imageFileType);
	...
	if($_FILES['img01_upload']['name']){
		...
		move_uploaded_file($_FILES['img01_upload']['tmp_name'], 'temp/image01.' . $imageFileType);//'images/image01.png');// . $_FILES['upload']['name']);
	...
	if($_FILES['img02_upload']['name']){
		...
		$imageFileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
		move_uploaded_file($_FILES['img02_upload']['tmp_name'], 'temp/image02.' . $imageFileType);
	...
	if($_FILES['img03_upload']['name']){
		...
		$imageFileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
		move_uploaded_file($_FILES['img03_upload']['tmp_name'], 'temp/image03.' . $imageFileType);
	...
	if($_FILES['img04_upload']['name']){
		...
		$imageFileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
		move_uploaded_file($_FILES['img04_upload']['tmp_name'], 'temp/image04.' . $imageFileType);
	...
	if($_FILES['img05_upload']['name']){
		...
		$imageFileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
		move_uploaded_file($_FILES['img05_upload']['tmp_name'], 'temp/image05.' . $imageFileType);
	...
	if($_FILES['img06_upload']['name']){
		...
		$imageFileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
		move_uploaded_file($_FILES['img06_upload']['tmp_name'], 'temp/image06.' . $imageFileType);
	...
	if($_FILES['img07_upload']['name']){
		...
		$imageFileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
		move_uploaded_file($_FILES['img07_upload']['tmp_name'], 'temp/image07.' . $imageFileType);
	...
	if($_FILES['img08_upload']['name']){
		...
		$imageFileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
		move_uploaded_file($_FILES['img08_upload']['tmp_name'], 'temp/image08.' . $imageFileType);
